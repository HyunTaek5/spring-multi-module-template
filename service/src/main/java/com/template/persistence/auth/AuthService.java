...
import com.template.persistence.user.exception.CustomBadCredentialException;
import com.template.persistence.user.exception.CustomInterAuthenticationServiceException;
import com.template.persistence.user.exception.NameDuplicateException;
import com.template.persistence.user.exception.UserNotFoundException;
import com.template.persistence.user.exception.UsernameDuplicateException;
